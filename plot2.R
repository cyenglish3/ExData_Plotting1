...
# Now create Plot #2 with specified arguments
# First launch the graphics device
png("plot2.png", width = 480, height = 480)

# Next, create the plot - a time series
plot(useData$DateTime, useData$Global_active_power, main = "Global Active Power",
